...
**What's coming in Module 1:** We take modular arithmetic — which you just got a taste of — and go deep. You'll learn why certain numbers have "inverses" and others don't, why primes are magical for creating mathematical systems, and how all of this connects to the ECDSA signatures your Thurin project verifies. It's the same concepts from this module, but with the volume turned up.

---

*Crypto Math for Engineers — Module 0: Foundations*
*Built for Thurin development. Not a textbook. Not a course. A workshop.*
